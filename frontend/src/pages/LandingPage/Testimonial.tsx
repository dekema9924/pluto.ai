                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center">
                        <div className="text-center">
                            <p className="text-2xl font-medium text-[wheat] ">2,157 people have said how good Rareblocks</p>
                            <h2 className="mt-4 text-gray-300 text-lg ">Our happy clients say about us</h2>
                        </div>
